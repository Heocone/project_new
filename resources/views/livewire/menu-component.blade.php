    ...
    <div class="categori-dropdown-wrap categori-dropdown-active-large">
        <ul>
            ...
            {{-- <li class="has-children">
                <a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-tshirt"></i>Men's Clothing</a>
                <div class="dropdown-menu">
                    <ul class="mega-menu d-lg-flex">
                        <li class="mega-menu-col col-lg-7">
                            <ul class="d-lg-flex">
            ...
            <li class="has-children">
                <a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-smartphone"></i> Cellphones</a>
                <div class="dropdown-menu">
                    <ul class="mega-menu d-lg-flex">
                        <li class="mega-menu-col col-lg-7">
                            <ul class="d-lg-flex">
            ...
            <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-desktop"></i>Computer & Office</a></li>
            <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-cpu"></i>Consumer Electronics</a></li>
            <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-diamond"></i>Jewelry & Accessories</a></li>
            <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-home"></i>Home & Garden</a></li>
            <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-high-heels"></i>Shoes</a></li>
            <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-teddy-bear"></i>Mother & Kids</a></li>
            <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-kite"></i>Outdoor fun</a></li> --}}
            {{-- <li>
                <ul class="more_slide_open" style="display: none;">
                    <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-desktop"></i>Beauty, Health</a></li>
                    <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-cpu"></i>Bags and Shoes</a></li>
                    <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-diamond"></i>Consumer Electronics</a></li>
                    <li><a href="{{ route('shop.index') }}"><i class="surfsidemedia-font-home"></i>Automobiles & Motorcycles</a></li>
                </ul>
            </li> --}}
        </ul>

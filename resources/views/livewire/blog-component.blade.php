                        ...
                        <div class="row">
                                ...
                                <article class="first-post mb-30 wow fadeIn animated hover-up">
                                    ...
                                    <div class="entry-content">
                                        ...
                                        <h2 class="post-title mb-20">
                                            <a href="{{ route('BlogDetail') }}">Barcelona: marathan; south korean pulls away for a grueling surprise</a></h2>
                                        ...
                                        <div class="mb-20 entry-meta meta-2">
                                            ...
                                            <a href="{{ route('BlogDetail') }}" class="btn btn-sm">Read more<i class="fi-rs-arrow-right ml-10"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                                ...
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ route('BlogDetail') }}">The litigants on the screen are not actors</a></h3>
                                        ...
                                        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                            ...
                                            <a href="{{ route('BlogDetail') }}" class="text-brand">Read more <i class="fi-rs-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ route('BlogDetail') }}">Essential Qualities of Highly Successful Music</a></h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ route('BlogDetail') }}">9 Things I Love About Shaving My Head</a></h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ route('BlogDetail') }}">Why Teamwork Really Makes The Dream Work</a></h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    ...
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="{{ route('BlogDetail') }}">The World Caters to Average People</a></h3>

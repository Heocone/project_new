                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                @if ($products->total() == 0)
                                <p> Không tìm được sản phẩm nào từ: <strong class="text-brand">{{ $searchvalue }} </strong>!
                                @else
                                <p> Có <strong class="text-brand">{{ $products->total() }}</strong> sản phẩm tìm kiếm được từ: <strong class="text-brand">{{ $searchvalue }} </strong>!
                                @endif

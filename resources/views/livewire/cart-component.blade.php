            ...
            <div class="container">
                <div class="row">
                    @if (Cart::instance('cart')->count() > 0)
                        <div class="col-12">
                            <div class="table-responsive">
                                ...
                                @endif
                                @if (Session::has('checkkout'))
                                <div class="alert alert-success">
                                    <strong>Success | {{ Session::get('checkkout') }}</strong>
                                </div>
                                @endif
                                @if (Cart::instance('cart')->count() > 0)
                            ...
                            <div class="cart-action text-end">
                                ...
                                <a class="btn " href="/shop"><i class="fi-rs-shopping-bag mr-10"></i>Thêm các mặt hàng khác</a>
                            </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    @if (Session::has('coupon'))
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="cart_total_amount"><i class="ti-gift mr-5"></i>Miễn phí</td>
                                                        </tr>
                                                        <tr>
                    ...
                    @else
                        <tr>
                            <td class="product-des product-name">
                                <h1 class="product-name">Giỏ hàng trống</h1>
                                <a href="/shop" class="btn"><i class="fi-rs-box-alt mr-10"></i>Thêm sản phẩm vào giỏ hàng</a>
                                </p>
                            </td>
                        </tr>
                    @endif

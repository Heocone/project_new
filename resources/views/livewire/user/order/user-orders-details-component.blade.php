                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="row">
                                ...
                                <a href="#" onclick="return confirm('Are you sure about that?')|| event.stopImmediatePropagation()" wire:click.prevent="cancelOrder" style="margin-right:20px;" class="btn btn-warning float-end">Hủy đơn hàng</a>
                                @elseif($order->status == 'canceled')  
                                <a href="/shop" style="margin-right:20px;" class="btn btn-success float-end">Mua sản phẩm khác</a>
                                @endif
                                </div>
                            </div>
                        </div>

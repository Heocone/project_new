                    ...
                    <div class="col-12">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('admin.sliders.add') }}" class="btn btn-outline-success float-md-end">Thêm slide mới</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    @foreach ($slides as $slide)
                                        <tr>
                                            <td>{{ $slide->id }}</td>
                                            <td><img src="{{ asset('assets/imgs/slider') }}/{{ $slide->image }}" alt="" width="150"></td>
                                            ...
                                            <td width="80">
                                                <a href="{{ route('admin.sliders.edit',['slide_id' => $slide->id]) }}" class="text-info"><i class=" fa fi-rs-edit"></i></a>
                                                <a href="#" class="text-danger" onclick="deleteConfirmationn({{ $slide->id }})" style="margin-left: 20px;"><i class=" fi-rs-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>

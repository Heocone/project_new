            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form method="post">
                            <div class="form-group">
                                <input type="text" required="" name="fname" placeholder="First name *" wire:model="firtsname">
                            </div>
                            <div class="form-group">
                                <input type="text" required="" name="lname" placeholder="Last name *" wire:model="lastname">
                            {{-- </div>
                            <div class="form-group">
                                <input required="" type="text" name="cname" placeholder="Company Name" wire:model="firtsname">
                            </div> --}}
                            <div class="form-group">
                            ...
                            <div class="ship_detail">
                                ...
                                <div id="collapseAddress" class="different_address collapse in">
                                    <div class="form-group">
                                        <input type="text" required="" name="fname" placeholder="First name *" wire:model="s_firtsname">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" required="" name="lname" placeholder="Last name *" wire:model="s_lastname">
                                     </div>
                                    <div class="form-group">
                                        <input required="" type="number" name="phone" placeholder="Phone *" wire:model="s_mobile">
                                    </div>
                                    {{--
                                    <div class="form-group">
                                        <input required="" type="text" name="cname" placeholder="Company Name" wire:model="s_firtsname">
                                    </div> --}}
                                    <div class="form-group">
                                        <div class="custom_select">
                    ...
                    <div class="col-md-6">
                        <div class="order_review">
                            ...
                            <div class="payment_method">
                                ...
                                <div class="payment_option">
                                    <div class="custome-radio">
                                        <input class="form-check-input" required="" value="cod" type="radio" name="payment_option" id="exampleRadios3">
                                    ...
                                    <div class="custome-radio">
                                        <input class="form-check-input" value="vnpay" required="" type="radio" name="payment_option" id="exampleRadios4">
                            ...
                            {{-- <a href="#" class="btn btn-fill-out btn-block mt-30"></a> --}}
